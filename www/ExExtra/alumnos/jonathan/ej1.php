...
/*
Ejercicio 1.- Tenemos un array con la información metereológica de 100 estaciones de todo el mundo. A partir de éste, obtén
la siguiente información y muestra por pantalla:
(1 punto) Cuantas estaciones pertenecen al Hemisferio Norte, teniendo en cuenta que el campo "coordenadas" nos proporciona la 
latitud y la longitud separadas por coma, y que una latitud positiva nos dice que la ubicación se encuentra en el Hemisferio Norte, 
y que una latitud negativa significa que la ubicación se encuentra en el Hemisferio Sur.
(0,75 puntos) La temperatura media de las estaciones del Hemisferio Sur.
(0,75 puntos) El listado estaciones han bajado de -20 grados o estan por encima de 40 grados.
*/

$hemisferioNorte = 1;
$hemisferioSur = 1;
$temperaturaMedia = 0;
$temperaturas_Altas_Y_Bajas = [];


foreach ($data as $estacion) {
    $coordenadas = explode(", ", $estacion["coordenadas"]);
    $latitud = $coordenadas[0];

    $temperatura = $estacion["numberrange"];
    ...
    if ($temperatura < -20 || $temperatura > 40) {
        $temperaturas_Altas_Y_Bajas[] = $estacion["estacion"];
    }

 

$temperaturaMedia = $temperaturaMedia / $hemisferioSur;
}

echo "Estaciones en el Hemisferio Norte: " . $hemisferioNorte . "<br>";
echo "Temperatura media en el Hemisferio Sur: " . $temperaturaMedia . "<br>";
echo "Estaciones con temperaturas altas o bajas: " . implode(", ", $temperaturas_Altas_Y_Bajas);
