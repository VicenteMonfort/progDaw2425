...
//Saber cuantos hay en el Norte (1 - Mayor 0) y en el Sud (1 - Menos 0)
$hemisferioNorte = 0;
$hemisferioSur = 0;
$hemisferioSurMedia = 0;
$tempMediaSur = 0;

foreach ($data as $estacion) {
    list($latitud, $longitud) = explode(',', $estacion['coordenadas']);
    $latitud = $latitud;
	...
	if ($temperatura < -20 || $temperatura > 40) {
        $estacionesExtremas[] = $estacion;
    }
}

$suma = array_sum($data);
$numberrange = count($data);
$tempMediaSur = $suma / $numberrange;

echo "Cantidad de estaciones en el Hemisferio Norte: $hemisferioNorte\n";
echo "<br>";
echo "Cantidad de estaciones en el Hemisferio Sud: $hemisferioSur\n";
echo "<br>";
echo "Temperatura media de las estaciones en el Hemisferio Sur: $tempMediaSur\n"; //Falta la media
echo "<br>";
echo "Listado de estaciones con temperaturas extremas:\n";
var_dump($estacionesExtremas);
?>