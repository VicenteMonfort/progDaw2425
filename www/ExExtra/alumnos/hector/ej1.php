...
foreach($data as  $cordenadas ){
    if( $coordenadas[""]>= 0 && $coordenadas[""]<=0){
        $donde="Coordenadas:".$coordenadas["latitud"]. ", longitud:". $coordenadas["longitud"];
    }
}
echo $donde;
if ($donde <= 0) {
	echo "es del Hemisferio Norte"
	
}
else 
 echo "Es del Hemisferio sur"
