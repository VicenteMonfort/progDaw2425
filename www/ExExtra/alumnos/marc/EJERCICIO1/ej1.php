...
//MEDIA TEMPERATURA HEMISFERIO SUR

function MediaHemisferioSur($array) {
...
$media_temperatura = calcularMedia($numeros);

echo "La media de temperatura en el Hemisferio Sur es: $media_temperatura\n";


//MEDIA TEMPERATURA HEMISFERIO SUR


$estaciones_menos_20 = array();
$estaciones_mas_40 = array();


foreach ($array as $numero) {

    if ($numero < -20) {
        $estaciones_menos_20 [] = $numero;
    } 
	if ($numero > 40) {
        $estaciones_mas_40 [] = $numero;
    }
}

echo "Estaciones que han bajado de -20: ";
foreach ($estaciones_menos_20 as $estacion20) {
    echo $estacion20 . " ";
}

echo "Estaciones que han superado los 40 grados: ";
foreach ($estaciones_mas_40 as $estacion40) {
    echo $estacion40 . " ";
}
?>