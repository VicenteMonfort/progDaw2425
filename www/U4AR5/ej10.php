<?php
/*
Ejercicio 10.- A partir del array $data proporcionado, muestra todos los usuarios que les gusta un plato de comida en concreto, pasado por GET, así como sus paises de procedencia. Aquí tienes un ejemplo de como queda la salida por pantalla:

Total people who like pasta: 9
People's countries who like pasta: Vietnam, Canada, China, Spain, Poland, Belgium, Peru

Evita que se repitan los paises al mostrarlos en pantalla.
        ...
        foreach ($favorites as $fav) {
            if ($fav == $food) {
                ...
                foreach ($countries as $country) {
                    if ($country == $user["Country"]) $notFound = false;
                }
                if ($notFound) array_push($countries, $user["Country"]);
            }
        }
    }
    echo "Total people who like $food: " . $totalMembers . "<brs";
    echo "People's countries who like $food: " . implode(", ", $countries);
}
