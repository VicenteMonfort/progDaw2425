<?php
/*
Ejercicio 9.- A partir del array $data proporcionado, muestra todos los usuarios que no tienen platos de comida favoritos, así como su edad media. Aquí tienes un ejemplo de como queda la salida por pantalla:
...
echo "Total people with no preferences: " . $totalMembers . "\n";
echo "Average Age for people with no preferences: " . ($totalAge / $totalMembers);
