<?php
/*
Ejercicio 8.- A partir del array $data proporcionado, muestra todos los usuarios de un país en concreto, pasado por GET. Aquí tienes un ejemplo de como queda la salida por pantalla:

People from Spain
-----------------------------
Chastity Mcgowan likes desserts, noodles
Raven Olsen likes all kinds of food
Quamar Powers likes pasta, seafood
Yoko Edwards likes sandwiches
Martena Weaver likes cereals, stews, pasta
Byron York likes pasta
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($data as $user) {
        if ($user["Country"] == $country) {
            echo $user["User"] . " likes ";
            if ($user["Favorites"] != "") {
                echo $user["Favorites"];
            } else {
                echo "all kinds of food";
            }
            echo "<br>";
        }
    }
