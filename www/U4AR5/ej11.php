<?php
/*
Ejercicio 10.- A partir del array $data proporcionado, ordena los usuario por edad de mayor a menor, usando el método de ordenación burbuja, tomando como ejemplo el siguiente código:

    $array = [5, 9, 4, 7, 3, 8, 2, 1, 6];
