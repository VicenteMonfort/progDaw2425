<?php
/*
Ejercicio 7.- A partir del array $data proporcionado, muestra todos los usuarios junto con su edad, siempre que cumplan el criterio de estar entre 35 y 65 años. Aquí tienes un ejemplo de como queda la salida por pantalla:

...
Lillith Herring is 62 years old
Aileen Kemp is 53 years old
Alfonso Mcfarland is 40 years old
...
...
foreach ($data as $user) {
    if ($user["Age"] > 35 && $user["Age"] < 65) {
        echo $user["User"] . " is " . $user["Age"] . " years old\n";
    }
}
